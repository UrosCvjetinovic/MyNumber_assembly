comment &
/************** MOJ BROJ *****************************************
Aplikacija je napisana koristeci Irvine32.inc biblioteku i Irvine-ove
preporuke za modele koji se koriste i velicinu steka za rad
u VS2017.
Po pokretanju igre korsnik se nalazi u Menu-u odakle moze zapoceti 
igru. U bilo kom trenutku tokom igranja moguce je napustiti igricu
pritiskom na ESC taster, cime se korisnik vraca u Menu
odakle se moze ponovnim pritiskom na ESC tester  izaci iz aplikacije.
Kod je realizovan modularno, i moze se podeliti u manje nezavisne 
procedure, i par procedura koje su uze povezane za samo logiku igranja.
Glavni program je realizovan tako sto je podeljen na faze igranja 
pomocu procedura sa nazivom koji to i implicira.
...
_RestartGame:
	INVOKE Menu				;//Pocetni meni, ESC izlzak iz programa, ostalo pocetak igre
		cmp al, ESC_KEY
		je _exit
